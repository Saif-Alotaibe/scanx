...
namespace ScanX.Core
{
    ...
    /// Use this instead of DeviceClient (WIA) for document scanners like Fujitsu fi-8170.
    /// </summary>
    public class TwainDeviceClient : IDisposable
    {
